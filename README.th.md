...
ใช้ได้บน **Windows 10 / 11** ไฟล์ `.exe` เดียว **22 KB**
...
| ไม่มี Export | Export CSV ผ่าน Save dialog |
...
| **Export CSV** | บันทึกข้อมูลที่ filter/sort อยู่ออกเป็นไฟล์ |
| **พกพา** | .exe เดียว ไม่มี dependencies 22 KB |
...
<div align="center">
  <small>GPLv3 License · ฟรี · สร้างด้วย C# WinForms</small>
</div>
